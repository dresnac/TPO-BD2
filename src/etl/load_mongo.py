...
def load_all():
    ...
    rows = (
        _csv(os.path.join(_DS, "propietarios.csv"))
        + _csv(os.path.join(_EXTRAS, "propietarios_extras.csv"))
    )

    db.propietarios.insert_many([
        {
            "_id": _id(r["id_propietario"]),
            "nombre": r["nombre"],
            "apellido": r["apellido"],
            "dni": r["dni"],
            "email": r["email"],
    ...
    db.pacientes.drop()
    rows = (
        _csv(os.path.join(_DS, "pacientes.csv"))
    ...
    db.pacientes.insert_many([
        {
            "_id": _id(r["id_paciente"]),
            "nombre": r["nombre"],
            "especie": r["especie"],
            "raza": r["raza"],
            "fecha_nac": _date(r["fecha_nac"]),
            "id_propietario": _id(r["id_propietario"]),
            "activo": _bool(r["activo"]),
        }
        for r in rows
    ])
    ...
    rows = (
        _csv(os.path.join(_DS, "veterinarios.csv"))
        + _csv(os.path.join(_EXTRAS, "veterinarios_extras.csv"))
    )
    ...
    db.consultas.drop()
    rows = (
        _csv(os.path.join(_DS, "consultas.csv"))
        + _csv(os.path.join(_EXTRAS, "consultas_extras.csv"))
    )

    db.consultas.insert_many([
        {
            "_id": _id(r["id_consulta"]),
            "id_paciente": _id(r["id_paciente"]),
            "id_vet": _id(r["id_vet"]),
            "fecha": _date(r["fecha"]),
            "motivo": r["motivo"],
            "diagnostico": r["diagnostico"],
            "costo": _float(r["costo"]),
            "estado": r["estado"],
        }
        for r in rows
    ])
    ...
    rows = (
        _csv(os.path.join(_DS, "vacunaciones.csv"))
        + _csv(os.path.join(_EXTRAS, "vacunaciones_extras.csv"))
    )
    ...
    db.vacunaciones.insert_many([
        {
            ...
            "id_paciente": _id(r["id_paciente"]),
            "id_vet": _id(r["id_vet"]),
            "fecha_aplicacion": _date(r["fecha_aplicacion"]),
    ...
    db.cirugias.drop()
    rows = (
        _csv(os.path.join(_DATA, "cirugias.csv"))
        + _csv(os.path.join(_EXTRAS, "cirugias_extras.csv"))
    )

    db.cirugias.insert_many([
        {
            "_id": _id(r["id_cirugia"]),
            "id_paciente": _id(r["id_paciente"]),
            "id_vet": _id(r["id_vet"]),
            "fecha": _date(r["fecha"]),
            "tipo": r["tipo"],
            ...
            "duracion_min": _int(r["duracion_min"]),
            "costo": _float(r["costo"]),
            "estado": r["estado"],
    ...
    rows = (
        _csv(os.path.join(_DS, "stock_farmaceutico.csv"))
        + _csv(os.path.join(_EXTRAS, "stock_farmaceutico_extras.csv"))
    )

    db.stock_farmaceutico.insert_many([
        {
            "_id": _id(r["id_producto"]),
            "nombre": r["nombre"],
            "categoria": r["categoria"],
            "unidades": _int(r["unidades"]),
            "precio_unit": _float(r["precio_unit"]),
            "vencimiento": _date(r["vencimiento"]),
